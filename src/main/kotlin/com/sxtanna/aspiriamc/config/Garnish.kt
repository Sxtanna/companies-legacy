...
sealed class Garnish<T : Any?> : ConfigPath<T> {
    ...
    object COMPANY_RENAME_PURCHASE_PASS : SoundGarnish("company.rename-purchase.pass") {

        override val default = ENTITY_PLAYER_LEVELUP

    }

    object COMPANY_RENAME_PURCHASE_FAIL : SoundGarnish("company.rename-purchase.fail") {
